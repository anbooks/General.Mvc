...
namespace General.Framework.Security.Ordinary
{
    public class OrdinaryAuthService : IOrdinaryAuthService
    {
        ...
        public SysUser getCurrentUser()
        {
            ...
            var result = _httpContextAccessor.HttpContext.AuthenticateAsync(CookieOrdinaryAuthInfo.AuthenticationScheme).Result;
            ...
            //http://localhost:50491/ordinary/main
        ...
        public void signIn(string token, string name)
        {
            ...
            _httpContextAccessor.HttpContext.SignInAsync(CookieOrdinaryAuthInfo.AuthenticationScheme, claimsPrincipal);
        ...
        public void signOut()
        {
            ...
            _httpContextAccessor.HttpContext.SignOutAsync(CookieOrdinaryAuthInfo.AuthenticationScheme);
