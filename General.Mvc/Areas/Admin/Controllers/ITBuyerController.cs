...
namespace General.Mvc.Areas.Admin.Controllers
{
    ...
    public class ITBuyerController : AdminPermissionController
    {
        ...
        public ITBuyerController(IOrderMainService sysOrderMainService,IInspectionService sysInspectionService, ISupplierService sysSupplierService, IProjectService sysProjectService, IMaterialService sysMaterialService, ISysUserRoleService sysUserRoleService, IOrderService sysOrderService, IHostingEnvironment hostingEnvironment, IScheduleService scheduleService, IImportTrans_main_recordService importTrans_main_recordService, ISysCustomizedListService sysCustomizedListService)
        {
