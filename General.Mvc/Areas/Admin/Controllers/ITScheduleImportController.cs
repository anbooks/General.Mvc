...
{
    //[Area("Admin")]
    [Route("admin/itScheduleImport")]
    public class ITScheduleImportController : AdminPermissionController
    {
        ...
        [Route("", Name = "itScheduleImportIndex")]
        [Function("明细数据导入", true, "menu-icon fa fa-caret-right", FatherResource = "General.Mvc.Areas.Admin.Controllers.DataImportController", Sort = 1)]
        ...
        [Route("Scheduleexcelimport", Name = "Scheduleexcelimport")]
        ...
        [HttpPost]
        [Route("Scheduleimportexcel", Name = "Scheduleimportexcel")]
        public ActionResult Import(IFormFile excelfile, string returnUrl = null)
        {
            ViewBag.ReturnUrl = Url.IsLocalUrl(returnUrl) ? returnUrl : Url.RouteUrl("itScheduleImportIndex");
